...
julia simulation/unrealistic_sim.jl -s 3323 -c 7 -k 50

echo "case 8: mean = 0.8, pi = 0.3, samptaxa=50"
julia simulation/unrealistic_sim.jl -s 3323 -c 8 -p 0.3 -k 50

echo "case 9: mean = 0.8, pi = 0.8, samptaxa=50"
julia simulation/unrealistic_sim.jl -s 3323 -c 9 -p 0.8 -k 50

echo "case 10: mean = 1.6, pi = 0.1, samptaxa=50"
julia simulation/unrealistic_sim.jl -s 3323 -c 10 -m 1.6 -k 50

echo "case 11: mean = 1.6, pi = 0.3, samptaxa=50"
julia simulation/unrealistic_sim.jl -s 3323 -c 11 -m 1.6 -p 0.3 -k 50

echo "case 12: mean = 1.6, pi = 0.8, samptaxa=50"
julia simulation/unrealistic_sim.jl -s 3323 -c 12 -m 1.6 -p 0.8 -k 50
